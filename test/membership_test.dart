...
void main() {
  ...
  test(
    'MembershipController defaults to inactive and activates with valid code',
    () async {
      ...
      expect(
        container.read(membershipControllerProvider).value?.active,
        isFalse,
      );
      ...
      final deactivatedState = container
  ...
  test(
    'MembershipController activates and deactivates via Star toggle',
    () async {
      final controller = container.read(membershipControllerProvider.notifier);
  ...
  testWidgets(
    'MembershipScreen renders activation cards and allows activating',
    (tester) async {
      ...
      expect(
        container.read(membershipControllerProvider).value?.method,
        'code',
      );
    },
  );
